...
We have presented a number of results on the performance characteristics of the \updimpl{} of the \SI{} method applied to physical problems. These warrant additional discussion to place them in context and examine their implications for experimental work.
